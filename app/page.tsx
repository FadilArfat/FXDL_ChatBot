...
import userPic from '../public/user2.png'
import botPic from '../public/chatgpt-icon.png'
...
const ChatMessage = ({text, from}: MessageProps) => {
  return (
    <div className="mb-5">
    {from == Creator.Me && (
      <div className=" p-4 rounded-lg flex gap-4 items-center whitespace-pre-wrap">
        <Image src={userPic} alt="User" width={40} />
        <p className="text-white">{text}</p>
      </div>
    )}
    {from == Creator.Bot && (
      <div className="bg-gray-600 p-4 rounded-lg flex gap-4 items-center whitespace-pre-wrap">
...
const ChatInput = ({onSend, disabled}: InputProps) => {
  ...
  return (
    ...
    <div className="text-center text-white mb-5">
      <h1 className=" text-3xl font-bold">FXDL CHAT BOT</h1>
      <h1 className="text-sm">Version 1.0.0-alpha</h1>
    </div>
